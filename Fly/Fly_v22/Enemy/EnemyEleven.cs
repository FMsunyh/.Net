...
namespace Fly
{
    ...
    /// 敌人类
    /// </summary>
    public class EnemyEleven : Roles
    {
        /// <summary>
        /// 获取图片路径
        /// </summary>
        private static string m_ImagePath = Directory.GetCurrentDirectory() + "\\images\\Enemy\\EnemyEleven\\";
        ...
        public EnemyEleven(int x, int y, bool good, int xspeed, int yspeed, int life)
        ...
        protected override void ThisBomb()
        {
            ...
            if (MainForm.m_EnemyRandom.Next(0, 50) < 10)
            {
                ...
                HitCheck.GetInstance().AddElement(new MedalEight(this, 0, MainForm.m_RollSpeed, 8));
            }
        ...
        {
            HitCheck.GetInstance().AddElement(new MissileEleven(this, this.Good, 10, 10, Missiles.MissileDirections[MainForm.m_EnemyRandom.Next(7, 12)], 30));
        }
