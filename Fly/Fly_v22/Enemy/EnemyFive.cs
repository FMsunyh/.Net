...
namespace Fly
{
    ...
    /// 敌人类
    /// </summary>
    public class EnemyFive : Roles
    {
        /// <summary>
        /// 获取图片路径
        /// </summary>
        private static string m_ImagePath = Directory.GetCurrentDirectory() + "\\images\\Enemy\\EnemyFive\\";
        ...
        public EnemyFive(int x, int y, bool good, int xspeed, int yspeed, int life)
        ...
        {
            HitCheck.GetInstance().AddElement(new MissileFive(this, this.Good, 10, 10, Missiles.MissileDirections[MainForm.m_EnemyRandom.Next(0, 7)], 30));
        }
        ...
        {     
            if (y > MainForm.m_GAMEHEIGHT - 200)
            {
                y -= m_YSPEED; 
            }
