...
namespace Fly
{
    ...
    /// 吃子弹类，升级主人公子弹
    /// </summary>
    public class EatGoodsEight:Missiles
    {
        /// <summary>
        /// 西瓜图片目录
        /// </summary>
        private static Image m_ImageEatGoods = Image.FromFile(Directory.GetCurrentDirectory() + "\\images\\Goods\\Fly_Goods08.gif");
        ...
        public EatGoodsEight(Roles role, bool good, int xspeed, int yspeed, MissileDirection dir, int power)
