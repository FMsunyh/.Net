...
namespace Fly
{
    public class GetEnemys
    {
        ...
        {
            HitCheck.GetInstance().AddElement(new EnemyTwo(MainForm.m_GAMEWIDTH + 30, MainForm.m_EnemyRandom.Next(100, 550), false, 10, 10, 20));
        }

        public static void GetEnemyThree()
        {
            HitCheck.GetInstance().AddElement(new EnemyThree(-50, MainForm.m_EnemyRandom.Next(80, 500), false, 15, 15, 20));
        }

        public static void GetEnemyFour()   
        {
            int rand = MainForm.m_EnemyRandom.Next(0, 2);
            HitCheck.GetInstance().AddElement(new EnemyFour(0, -50, false, 20, 20, 30, rand == 0 ? true : false));
        }
