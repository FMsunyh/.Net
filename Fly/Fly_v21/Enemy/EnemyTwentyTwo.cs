...
namespace Fly
{
    ...
    /// 敌人类
    /// </summary>
    public class EnemyTwentyTwo : Roles
    {
        /// <summary>
        /// 获取图片路径
        /// </summary>
        private static string m_ImagePath = Directory.GetCurrentDirectory() + "\\images\\Enemy\\EnemyTwentyTwo\\";
        ...
        public EnemyTwentyTwo(int x, int y, bool good, int xspeed, int yspeed, int life)
            : base(x, y, good, m_EnemyImage[0].Width / 6, m_EnemyImage[0].Height, xspeed, yspeed, life)
        {
        }
        ...
        public override void Draw(Graphics g)
        {
            ...
            if (step < 6)
            {
                rect = new Rectangle((m_EnemyImage[0].Width / 6) * step, 0, m_EnemyImage[0].Width / 6, m_EnemyImage[0].Height);
