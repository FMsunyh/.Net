...
namespace Fly
{
    ...
    /// 敌人类
    /// </summary>
    public class EnemyTen : Roles
    {
        /// <summary>
        /// 获取图片路径
        /// </summary>
        private static string m_ImagePath = Directory.GetCurrentDirectory() + "\\images\\Enemy\\EnemyTen\\";
        ...
        public EnemyTen(int x, int y, bool good, int xspeed, int yspeed, int life)
        ...
        {
            HitCheck.GetInstance().AddElement(new MissileTen(this, this.Good, 10, 10, Missiles.MissileDirections[MainForm.m_EnemyRandom.Next(7, 12)], 30));
        }
