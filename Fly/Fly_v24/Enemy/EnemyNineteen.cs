...
namespace Fly
{
    ...
    /// 敌人类
    /// </summary>
    public class EnemyNineteen : Roles
    {
        /// <summary>
        /// 获取图片路径
        /// </summary>
        private static string m_ImagePath = Directory.GetCurrentDirectory() + "\\images\\Enemy\\EnemyNineteen\\";
        ...
        public EnemyNineteen(int x, int y, bool good, int xspeed, int yspeed, int life)
        ...
        protected override void ThisBomb()
        {
            ...
            {
                HitCheck.GetInstance().AddElement(new EatGoodsSeven(this, !this.Good, 5, 5, MissileDirection.STOP, 7));
                HitCheck.GetInstance().AddElement(new MedalSix(this, 0, MainForm.m_RollSpeed, 6));
            }
        }
        ...
        {
            HitCheck.GetInstance().AddElement(new MissileNineteen(this, this.Good, 10, 10, Missiles.MissileDirections[MainForm.m_EnemyRandom.Next(7, 12)], 30));
        }
