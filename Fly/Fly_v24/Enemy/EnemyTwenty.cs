...
namespace Fly
{
    ...
    /// 敌人类
    /// </summary>
    public class EnemyTwenty : Roles
    {
        /// <summary>
        /// 获取图片路径
        /// </summary>
        private static string m_ImagePath = Directory.GetCurrentDirectory() + "\\images\\Enemy\\EnemyTwenty\\";
        ...
        public EnemyTwenty(int x, int y, bool good, int xspeed, int yspeed, int life)
        ...
        protected override void ThisBomb()
        {
            ...
            if (MainForm.m_EnemyRandom.Next(0, 200) < 10)
            {
                ...
                HitCheck.GetInstance().AddElement(new MedalSeven(this, 0, MainForm.m_RollSpeed, 7));
            }
        }
        ...
        {
            HitCheck.GetInstance().AddElement(new MissileTwenty(this, this.Good, 10, 10, Missiles.MissileDirections[MainForm.m_EnemyRandom.Next(7, 12)], 30));
        }
