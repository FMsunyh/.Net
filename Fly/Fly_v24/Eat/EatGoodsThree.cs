...
namespace Fly
{
    ...
    /// 吃子弹类，升级主人公子弹
    /// </summary>
    public class EatGoodsThree:Missiles
    {
        /// <summary>
        /// 西瓜图片目录
        /// </summary>
        private static Image m_ImageEatGoods = Image.FromFile(Directory.GetCurrentDirectory() + "\\images\\Goods\\Fly_Goods03.gif");
        ...
        public EatGoodsThree(Roles role, bool good, int xspeed, int yspeed, MissileDirection dir, int power)
