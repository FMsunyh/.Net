...
namespace Fly
{
    public class MissileThree : Missiles
    {
        ...
        {
            {"L",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"LU",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"LUU",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"U",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"RU",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"RUU",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"R",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"RD",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"RDD",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"D",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"LD",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
            {"LDD",Image.FromFile(m_ImagePath+"Fly_TEnemyBullet03.png")},
        };
