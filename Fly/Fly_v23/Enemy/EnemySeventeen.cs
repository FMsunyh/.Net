...
namespace Fly
{
    ...
    /// 敌人类
    /// </summary>
    public class EnemySeventeen : Roles
    {
        /// <summary>
        /// 获取图片路径
        /// </summary>
        private static string m_ImagePath = Directory.GetCurrentDirectory() + "\\images\\Enemy\\EnemySeventeen\\";
        ...
        public EnemySeventeen(int x, int y, bool good, int xspeed, int yspeed, int life)
        ...
        protected override void ThisBomb()
        {
            ...
            {
                HitCheck.GetInstance().AddElement(new EatGoodsSix(this, !this.Good, 5, 5, MissileDirection.STOP, 6));
                HitCheck.GetInstance().AddElement(new MedalFour(this, 0, MainForm.m_RollSpeed, 4));
            }
        ...
        {
            HitCheck.GetInstance().AddElement(new MissileSeventeen(this, this.Good, 10, 10, Missiles.MissileDirections[MainForm.m_EnemyRandom.Next(7, 12)], 30));
        }
