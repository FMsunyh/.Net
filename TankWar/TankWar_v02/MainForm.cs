...
namespace TankWar
{
    public partial class MainForm : Form
    {
        ...
        /// 获取或设置游戏窗口的宽度
        /// </summary>
        public const int _GAMEWIDTH = 800;

        /// <summary>
        /// 获取或设置游戏窗口的高度
        /// </summary>
        public const int _GAMEHEIGHT = 600;
        ...
        {
            this.Width = _GAMEWIDTH +20;        //设置窗口的宽度
            this.Height = _GAMEHEIGHT +40;      //设置窗口的高度
        ...
        {
            g.DrawImage(_Background, 0, 0, 600, 750);
        }
