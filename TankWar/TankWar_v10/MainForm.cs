...
namespace TankWar
{
    public partial class MainForm : Form
    {
        ...
        private void GetEnemys()
        {
            ...
            {
                HitCheck.GetInstance().AddElement(new EnemyOne(m_EnemyRandom.Next(1, 9)*80, 100, false, 10, 10, 10));
            }
        }
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            HitCheck.GetInstance().AddElement(new Tank(100,500, 10, 10, 200, true));
            GetMap();
        ...
        private void MainForm_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (HitCheck.GetInstance().MyTank.IsLive!=true)
            {
